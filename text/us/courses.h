COURSE_ACTS(COURSE_BOB, _(" 1 BOB-OMB BATTLEFIELD"),
       ...
       _("FIND THE 8 RED COINS")          , _("SONIC WINGS TO THE SKY")        , _("BEHIND CHAIN CHOMP'S GATE"))
...
COURSE_ACTS(COURSE_HMC, _(" 6 HAZY MAZE CAVE"),
       _("SWIMMING BEAST IN THE CAVERN")  , _("ELEVATE FOR 8 RED COINS")       , _("METAL-HEAD SONIC CAN MOVE!"),
...
SECRET_STAR(COURSE_WMOTR, _("   WING SONIC OVER THE RAINBOW"))
